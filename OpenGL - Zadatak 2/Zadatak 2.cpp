// Umesto da izvlacim koordinate tacaka iz autocada kako bih iscrtao inicijale u stilu fonta, odlucio sam da koristim biblioteku "freetype"
...
namespace glfreetype {
    ...
    void font_data::init(const char * fname, unsigned int h) {
        ...
        if (FT_New_Face( library, "\BlackOpsOne-Regular.ttf", 0, &face ))
...
int main(int argc, char** argv)
{
    ...
    int windowWidth = 500;
    int windowHeight = 90;
    window = glfwCreateWindow(windowWidth, windowHeight, "OpenGL - zadatak 2", NULL, NULL);
    if (!window) {
        glfwTerminate();
        return -1;
    }
    ...
    our_font.init("glfreetype\BlackOpsOne-Regular.ttf", 40 /* size */);
